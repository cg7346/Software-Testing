...
//part 3.2: SchoolOfInfoInfo - Kai Frazier
class SchoolOfInfoInfo {
    ...
    public void testSwenDeptInfo() throws Exception {
        ...
        try{
            ...
            WebElement schoolOfInfoInfo = driver.findElement(By.xpath("//*[@id=\"card-header-4315\"]/p/a/span[1]"));
            schoolOfInfoInfo.click();
            //make sure page is loaded
            Thread.sleep(1000);
            //find desired elements
            String contactName = driver.findElement(By.xpath("//*[@id=\"card-collapse-4315\"]/div/div[1]/article/div/div[2]/div[1]/a")).getText();
            String contactEmail = driver.findElement(By.xpath("//*[@id=\"card-collapse-4315\"]/div/div[1]/article/div/div[3]/div[1]/a")).getText();
            String contactTitle = driver.findElement(By.xpath("//*[@id=\"card-collapse-4315\"]/div/div[1]/article/div/div[2]/div[2]")).getText();
            String contactDepartment = driver.findElement(By.xpath("//*[@id=\"card-collapse-4315\"]/div/div[1]/article/div/div[2]/div[3]")).getText();
            String contactCollege = driver.findElement(By.xpath("//*[@id=\"card-collapse-4315\"]/div/div[1]/article/div/div[2]/div[4]")).getText();
